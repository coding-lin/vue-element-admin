  ...
  <div class="user-activity">
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">公开发布 - 今天 19:30</span>
      </div>
      <p>
        示例文本用于展示排版效果，广泛应用于设计、印刷等领域。
        有人不喜欢它，也有人基于它创建了许多优秀的工具，
        从设计稿占位符到字体测试，都能看到它的身影。
      </p>
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">发了一条消息 - 昨天</span>
      </div>
      <p>
        示例文本用于展示排版效果，广泛应用于设计、印刷等领域。
        有人不喜欢它，也有人基于它创建了许多优秀的工具，
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">发布了 4 张照片 - 2 天前</span>
      </div>
